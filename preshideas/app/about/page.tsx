          ...
          <div className="space-y-8 lg:space-y-12 pt-8 lg:pt-16">
            ...
            <div className="space-y-1">
              <h1 className="text-6xl sm:text-7xl lg:text-8xl xl:text-9xl font-bold text-gray-900 leading-[0.9] tracking-tight">
                <span className="inline-block animate-[fadeInUp_0.6s_ease-out]">We craft </span>
                <span className="font-serif italic font-light inline-block animate-[fadeInUp_0.6s_ease-out_0.5s_both]">PreshIdeas</span>
                <span className="inline-block animate-[fadeInUp_0.6s_ease-out_0.2s_both]"> that change the game</span>
              </h1>
            </div>
            ...
            <div className="max-w-xl space-y-6 lg:space-y-8 pt-4 animate-[fadeInUp_0.6s_ease-out_0.3s_both]">
              <div className="flex items-start gap-5">
                <svg className="w-6 h-6 lg:w-7 lg:h-7 mt-1 flex-shrink-0 animate-spin" style={{animationDuration: '8s'}} viewBox="0 0 64 64" fill="currentColor">
                  <path d="m1 32 25 6 6 25 6-25 25-6-25-6-6-25-6 25z" />
                </svg>
                <p className="text-base lg:text-lg leading-relaxed">
                  <span className="text-gray-900">We're a team of designers, developers, and strategists bringing bold ideas to </span>
                  <span className="text-gray-500">life with purpose, passion, and unforgettable execution.</span>
                </p>
              </div>
            ...
            <div className="pt-8 lg:pt-12 animate-[fadeInUp_0.6s_ease-out_0.4s_both]">
              <p className="text-xs lg:text-sm text-gray-700">(21.0278° N, 105.8342° E)</p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-end pt-0 lg:pt-32 animate-[fadeInRight_0.8s_ease-out_0.2s_both]">
            <div className="relative w-full max-w-sm lg:max-w-md group/video">
              ...
              <div className="absolute -top-12 -left-12 w-32 h-32 z-20">
                <div className="w-full h-full animate-spin" style={{ animationDuration: '20s' }}>
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <text className="text-[10px] fill-gray-900 font-semibold uppercase tracking-widest" style={{ letterSpacing: '0.1em' }}>
              ...
              <div className="relative rounded-2xl lg:rounded-3xl overflow-hidden aspect-[3/4] shadow-2xl hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.4)] transition-all duration-500 ring-1 ring-gray-200/50">
                ...
                >
                  <source src="https://assets.mixkit.co/videos/preview/mixkit-couple-watching-tv-together-4642-large.mp4" type="video/mp4" />
                </video>
