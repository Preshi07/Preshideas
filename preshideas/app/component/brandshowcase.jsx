...
export default function BrandSlider() {
  return (
    <div className="bg-background text-foreground min-h-screen grid-pattern overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-16 py-12 sm:py-16 lg:py-24">
        {/* Hero Section */}
        <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-accent/10 border border-accent/20 mb-6 sm:mb-8"
              >
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mb-10 sm:mb-12">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 sm:px-8 py-3 sm:py-4 rounded-full border border-border font-semibold text-sm sm:text-base hover:bg-muted hover:border-muted-foreground/30 transition-all duration-300 backdrop-blur-sm text-center"
                >
                  Explore the Product
                </motion.a>
              </div>
            ...
            <div className="lg:col-span-5 grid grid-cols-1 gap-4 sm:gap-6">
              {stats.map((stat, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="relative p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-all duration-300">
                      <div className="flex items-start justify-between mb-3 sm:mb-4">
                        <div className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">
                          {stat.value}
                        </div>
                        <div className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-accent/10 group-hover:bg-accent/20 transition-colors">
        ...
        <div className="relative mb-14 sm:mb-19 lg:mb-25">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-muted/50 backdrop-blur-sm mb-3 sm:mb-4">
              <Users className="w-3 h-3 sm:w-4 sm:h-4 text-muted-foreground" />
              <span className="text-xs sm:text-sm uppercase tracking-widest text-muted-foreground font-semibold">
          ...
          <div className="relative py-8 sm:py-10 overflow-hidden">
            ...
            >
              <div className="animate-scroll flex items-center gap-12 sm:gap-16 lg:gap-28">
                {[...logos, ...logos, ...logos].map((logo, idx) => (
                  <div
                    key={idx}
                    className="logo-shimmer flex-shrink-0 flex items-center justify-center min-w-[140px] sm:min-w-[180px] lg:min-w-[220px] h-16 sm:h-20 lg:h-24 grayscale hover:grayscale-0 opacity-50 hover:opacity-100 transition-all duration-500 hover:scale-110"
                  >
                    <Image
                      ...
                      width={160}
                      height={90}
                      className="object-contain w-auto h-10 sm:h-14 lg:h-18"
          ...
          <div className="pt-12 sm:pt-16 lg:pt-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-20 items-start">
              ...
              <motion.div
                ...
                className="lg:pl-12 space-y-6 sm:space-y-8"
              >
                <div className="p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-card/30 backdrop-blur-sm border border-border/50 hover:border-border transition-colors duration-300">
                ...
                <div className="p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-accent/5 to-transparent border border-accent/20 hover:border-accent/40 transition-colors duration-300">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">
                    Ship with confidence.
                  </h3>
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                    Preview deployments, instant rollbacks, and comprehensive
                    analytics give you complete control.
                  </p>
                </div>
              </motion.div>
            </div>
